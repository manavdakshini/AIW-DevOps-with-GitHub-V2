...
1. On the **Create a new repository** screen, name the repository **aiw-devops-with-github-lab-files**, select **Public** **(2)** and click on **Create repository** **(3)** button.
   ...
   > **Note**: If you observe any repository existing with the same name, please make sure you delete the Repo and create a new one. Please follow the steps given below the notes. Else, skip to step 6.
